"""Floating canvas-relative layout transformer."""
...
from ..schema import FLOATING_ROLES
from .common import LayoutTokenEncoder, make_head


class FloatingLayoutTransformer(nn.Module):
    """Predict target canvas-normalized bboxes and visibility for floating roles."""

    def __init__(
        self,
        num_roles: int = len(FLOATING_ROLES),
